...
A responsive, multi-page finance portfolio with dedicated About, Projects, Experience, Highlights, Interests, Resume, and Contact pages, plus three detailed work stories. The site uses plain HTML and CSS and has no external dependencies.
