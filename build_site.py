...
"index.html": page("Overview", "Finance, business experience, and campus involvement from Caua Kevyn Martins Brasil.", "index.html", f'''
  ...
  <section class="section"><div class="section-head"><div><span class="eyebrow">Experience in action</span><h2>Selected projects &amp; experience</h2></div><a class="text-link" href="projects.html">All work →</a></div><div class="project-list">{''.join(projects)}</div></section>
  ...
  <section class="toolkit-section"><div><span class="eyebrow">Technical toolkit</span><h2>Tools &amp; interests</h2><p>Excel (PivotTables and formulas), Google Sheets, QuickBooks, Python, and PowerPoint.</p></div><div><p>My professional interests include corporate finance, operating performance, and small-business working capital.</p><a class="text-link" href="interests.html">Explore my interests →</a></div></section><section class="section journey-section"><div><span class="eyebrow">The journey so far</span><h2>Career development</h2><p class="body-copy">My experience connects accurate financial records with operational decisions, client communication, and structured research.</p><a class="text-link" href="about.html">Get to know me →</a></div><div class="journey-list"><a href="highlights.html#leadership"><span>2026</span><div><h3>A new chapter at Rutgers</h3><p>Studying finance and joining ALPFA.</p></div><span aria-hidden="true">↗</span></a><a href="experience.html"><span>2025–26</span><div><h3>Business from the inside</h3><p>Operations at Master Pizza; finance at High Rise Capital.</p></div><span aria-hidden="true">↗</span></a><a href="project-bergecco.html"><span>2023</span><div><h3>A winning team proposal</h3><p>Bergecco-Parc Consulting: budgeting and tourism strategy for the Bergen County Historical Society.</p></div><span aria-hidden="true">↗</span></a></div></section>
...
<section class="connect-banner"><div><span class="eyebrow">Team achievement · December 2023</span><h2>Bergecco-Parc Consulting: winning team</h2><p>Member of Team Two in Bergen Community College’s tourism consulting competition for the Bergen County Historical Society. The instructor’s published recap identifies Team Two as the winner.</p></div><a class="button" href="project-bergecco.html">Explore the project →</a></section>
<section id="leadership" class="section"><div class="section-head"><div><span class="eyebrow">Leadership &amp; involvement</span><h2>Campus leadership</h2></div></div><div class="involvement-grid"><article class="involvement-card"><span class="eyebrow">President · 2024–2025</span><h3>Legal Studies Club</h3><p class="organization">Bergen Community College</p><p>Organized programming and member engagement around law, business, and professional development.</p></article><article class="involvement-card"><span class="eyebrow">Member · 2026–present</span><h3>ALPFA</h3><p class="organization">Rutgers University</p><p>Association of Latino Professionals For America. Continuing my campus involvement as I study finance at Rutgers.</p></article><article class="involvement-card wide"><span class="eyebrow">Additional involvement</span><h3>Bergen campus involvement</h3><ul class="chip-list"><li>Student Government Association · Judicial Member</li><li>Latin American Student Association · Member</li><li>Motion: Student Achievement Club · Member</li></ul></article></div></section>
...
"about.html": page("About", "Learn about Caua Kevyn Martins Brasil's education, leadership, and interest in finance.", "about.html", f'''
  <div class="wrap"><header class="page-intro"><span class="eyebrow">The person behind the work</span><h1>About me</h1>
    <p class="lead">I’m a Rutgers Business School finance student with experience in business operations, small-business financing, and legal research. I’m seeking opportunities to apply that background to financial analysis and reporting.</p></header>
...
"experience.html": page("Experience", "Professional experience in operations, finance, and legal research.", "experience.html", f'''
  <div class="wrap"><header class="page-intro compact"><span class="eyebrow">Operations · Finance · Legal research</span><h1>Professional experience</h1>
    <p class="lead">Experience in cash reconciliation, operating cost analysis, small-business finance, and legal research. My responsibilities combine accuracy with communication and team coordination.</p></header>
    <section class="timeline" aria-label="Professional experience">
      <article class="timeline-entry"><span class="timeline-date">June 2025 — present<br>Carlstadt, NJ</span><div><h2>Master Pizza</h2><p class="role-name">Operations intern &amp; team lead</p>
        <ul><li>Reconcile roughly $1,000–$3,000 in daily cash and deposits, checking end-of-day totals and maintaining deposit records.</li><li>Review delivery commissions, payroll, marketing budgets, and pricing to understand operating costs.</li><li>Support shift coordination and train new staff on POS systems and store procedures.</li></ul>
...
"resume.html": page("Resume", "Resume overview for Caua Kevyn Martins Brasil, finance student at Rutgers Business School.", "resume.html", f'''
  <div class="wrap"><header class="page-intro compact"><span class="eyebrow">Caua Kevyn Martins Brasil</span><h1>Resume</h1>
    <p class="lead">Finance student with experience in cash reconciliation, operating costs, small-business funding, and legal research.</p>
...
"interests.html": page("Interests", "Professional interests in corporate finance, business analysis, and working capital.", "interests.html", '''<div class="wrap"><header class="page-intro"><span class="eyebrow">Areas I want to explore</span><h1>Interests</h1><p class="lead">I’m interested in finance that helps explain business performance and supports better operating and funding decisions.</p></header><div class="interest-grid"><article class="info-card"><span class="eyebrow">Corporate finance</span><h2>Planning &amp; performance</h2><p>I want to develop my understanding of budgeting, forecasting, and variance analysis: how organizations set expectations, compare them with results, and decide what to adjust.</p><p>My exposure to payroll, delivery costs, pricing, and marketing spend gives me an operating context for these questions.</p></article><article class="info-card"><span class="eyebrow">Business analysis</span><h2>Revenue &amp; cost drivers</h2><p>I’m interested in how order volume, pricing, and expenses affect profitability. I want to become more effective at organizing data and explaining what changes in a business’s performance.</p><p>The Bergecco-Parc team proposal connected attendance and ticket pricing to a fundraising goal, making those relationships concrete.</p></article><article class="info-card"><span class="eyebrow">Small-business finance</span><h2>Working capital</h2><p>I’m interested in how businesses plan for cash needs and evaluate financing structures. My internship introduced me to conversations about funding amounts, repayment terms, and product fit.</p><p>I want to build a deeper understanding of cash flow and the financial information behind those decisions.</p></article><article class="info-card"><span class="eyebrow">Analytical development</span><h2>Excel &amp; financial research</h2><p>I’m interested in developing stronger spreadsheet analysis and financial statement interpretation skills, building on coursework in accounting, economics, statistics, and Python.</p><p>My legal research experience also informs how I organize information and write clear, evidence-based summaries.</p></article></div><section class="connect-banner"><div><span class="eyebrow">Opportunities</span><h2>Learning through practical experience</h2><p>I’m seeking internships where I can contribute to research, reporting, and analysis while developing my finance skills.</p></div><a class="button" href="contact.html">Contact me ↗</a></section></div>'''),
...
"project-operations.html": page("Operational Analysis", "An experience note on store operations, reconciliation, and business drivers.", "projects.html", '''
  <div class="wrap"><header class="page-intro compact"><a class="text-link back-link" href="projects.html">← All projects</a><span class="eyebrow">02 / Operations · analysis</span><h1>Cash Reconciliation &amp; Operations</h1>
    ...
    <div class="case-layout"><div>
      <section><h2>The setting</h2><p>At Master Pizza, my responsibilities include cash reconciliation, deposit records, and reviewing operating costs. I also help coordinate shifts and train staff.</p></section>
      ...
      <section class="case-next"><a class="text-link" href="experience.html">See professional experience <span aria-hidden="true">↗</span></a></section>
...
"project-funding.html": page("Small-Business Financing", "An experience note on client discovery and small-business working-capital options.", "projects.html", '''
  <div class="wrap"><header class="page-intro compact"><a class="text-link back-link" href="projects.html">← All projects</a><span class="eyebrow">03 / Finance · client discovery</span><h1>Small-Business Financing</h1>
    ...
    <div class="case-layout"><div>
      ...
      <section><h2>Financial relevance</h2><p>Working-capital discussions connect a business’s need for cash with the amount and repayment structure of potential financing. Explaining those terms clearly was central to the client conversations I supported.</p><p>This internship gave me experience in prospect qualification and financial communication. It strengthened my ability to explain financial information clearly and keep client conversations focused on the business need.</p></section><section><h2>Skills developed</h2><p>High-volume outreach required concise explanations, organized follow-up, and careful listening. Those skills are relevant to finance roles where understanding a business’s situation is as important as presenting numerical information.</p></section>
      <section class="case-next"><a class="text-link" href="experience.html">See professional experience <span aria-hidden="true">↗</span></a></section>
