...
"index.html": page("Overview", "Finance, business experience, and campus involvement from Caua Kevyn Martins Brasil.", "index.html", f'''
  ...
  <div class="evidence-strip" aria-label="Experience at a glance"><div><strong>$1K–$3K</strong><span>Daily cash &amp; deposits reconciled</span></div><div><strong>200+</strong><span>Daily orders at Master Pizza</span></div><div><strong>100+</strong><span>Daily outreach contacts at High Rise</span></div><div><strong>16+</strong><span>Active legal matters researched</span></div></div>
  ...
  <div class="wrap"><header class="page-intro compact"><span class="eyebrow">Operations · Finance · Legal research</span><h1>Professional experience</h1>
    ...
    <section class="timeline" aria-label="Professional experience">
      <article class="timeline-entry"><span class="timeline-date">June 2025 — present<br>Carlstadt, NJ</span><div><h2>Master Pizza</h2><p class="role-name">Operations intern &amp; team lead</p>
        <ul><li>Reconcile roughly $1,000–$3,000 in daily cash and deposits, checking end-of-day totals and maintaining deposit records.</li><li>Review delivery commissions, payroll, marketing budgets, and pricing in a location processing more than 200 orders on a typical day.</li><li>Coordinate counter and delivery staff during peak shifts and train 4–6 new employees on POS systems, order processing, and front-of-house procedures.</li></ul>
...
"resume.html": page("Resume", "Resume overview for Caua Kevyn Martins Brasil, finance student at Rutgers Business School.", "resume.html", f'''
  <div class="wrap"><header class="page-intro compact"><span class="eyebrow">Caua Kevyn Martins Brasil</span><h1>Resume</h1>
    ...
    <div class="resume-item"><h3>Master Pizza</h3><span class="date">June 2025 — present</span><p>Operations Intern &amp; Team Lead</p><ul class="resume-bullets"><li>Reconcile $1,000–$3,000 in daily cash and deposits and maintain accurate deposit records.</li><li>Analyze delivery commissions, payroll, marketing budgets, and pricing at a location processing 200+ daily orders.</li><li>Coordinate counter and delivery staff and train 4–6 new employees on POS systems and procedures.</li></ul></div>
